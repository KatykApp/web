    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use the <code>border-0</code> class to set alert without border.</p>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use the <code>alert-link</code> class at &lt;a&gt; tag to show matching colored
                        links within the given alert.</p>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use the <code>border-2 bg-body-secondary</code> class to set an alert with
                        outline.</p>
                    ...
                    <div class="live-preview">
                        <div class="row">
                            <div class="col-xl-6">
                                ...
                                <div class="alert alert-primary alert-dismissible border-2 bg-body-secondary fade show"
                                    role="alert">
                                ...
                                <div class="alert alert-secondary alert-dismissible border-2 bg-body-secondary fade show"
                                    role="alert">
                                ...
                                <div class="alert alert-success alert-dismissible border-2 bg-body-secondary fade show"
                                    role="alert">
                                ...
                                <div class="alert alert-danger alert-dismissible border-2 bg-body-secondary fade show mb-xl-0"
                                    role="alert">
                            ...
                            <div class="col-xl-6">
                                ...
                                <div class="alert alert-warning alert-dismissible border-2 bg-body-secondary fade show"
                                    role="alert">
                                ...
                                <div class="alert alert-info alert-dismissible border-2 bg-body-secondary fade show"
                                    role="alert">
                                ...
                                <h6>Dark Alert</h6>
                                <div class="alert alert-dark alert-dismissible border-2 bg-body-secondary fade show mb-0"
                                    role="alert">
                    ...
                    <div class="live-preview">
                        <div class="row">
                            ...
                            <div class="col-xl-6">
                                ...
                                <h6>Light Alert</h6>
                                <div class="alert alert-light alert-border-left alert-dismissible fade show"
                                    role="alert">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use the <code>alert-label-icon</code> class to set an alert with a label icon.
                    </p>
                    <div class="live-preview">
                        <div class="row">
                            <div class="col-xl-6">
                                ...
                                <h6>Danger Alert</h6>
                                <div class="alert alert-danger alert-dismissible bg-danger text-white alert-label-icon fade show mb-xl-0"
                                    role="alert">
                            ...
                            <div class="col-xl-6">
                                ...
                                <h6>Light Alert</h6>
                                <div class="alert alert-light alert-dismissible bg-light text-body alert-label-icon fade show"
                                    role="alert">
                                ...
                                <h6>Dark Alert</h6>
                                <div class="alert alert-dark alert-dismissible bg-dark text-white alert-label-icon fade show mb-0"
                                    role="alert">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use the <code>alert-additional</code> class and Use the <code>alert-</code> class
                        to HTML elements like headings, paragraphs, dividers etc.</p>
                    <div class="live-preview">
                        <div class="row">
                            <div class="col-xl-6">
                                <h6>Primary Alert</h6>
                                    ...
                                    <div class="alert-body">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <p class="mb-0">This alert needs your attention, but it's not super
                                                    important.</p>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use the <code>alert-top-border</code> class to set an alert with the top border
                        and outline.</p>
                    <div class="live-preview">
                        <div class="row">
                            <div class="col-xl-6">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use the <code>alert-label-icon rounded-label</code> class to set an alert with a
                        rounded label icon.</p>
                    <div class="live-preview">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use the <code>bg-*</code>, <code>border-*</code> & <code>text-white</code> class
                        to set an alert with solid style.</p>
                    ...
                    <div class="live-preview">
                        <div class="row">
                            <div class="col-xl-6">
                                ...
                                <div class="alert bg-danger border-danger text-white mb-xl-0" role="alert">
