...
@endsection
@section('css')
    <link href="{{ URL::asset('assets/libs/multi.js/multi.min.css') }}" rel="stylesheet">
    <link href="{{ URL::asset('assets/libs/@tarekraafat/autocomplete.js/css/autoComplete.css') }}" rel="stylesheet">
@endsection
@section('content')
    <div class="row">
        <div class="col-lg-12">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="mt-3">
                                ...
                                <div data-input-flag data-option-flag-img-name>
                                    <input type="text" class="form-control rounded-end flag-input" readonly
                                        value="United States" placeholder="Select country" data-bs-toggle="dropdown"
                                        aria-expanded="false" />
                                    <div class="dropdown-menu w-100">
                                        <div class="p-2 px-3 pt-1 searchlist-input">
                                            <input type="text"
                            ...
                            <div class="mt-3">
                                ...
                                <div data-input-flag data-option-flag-name data-search-input="false">
                                    <input type="text" class="form-control rounded-end flag-input" readonly
                                        value="" placeholder="Select country" data-bs-toggle="dropdown"
                                        aria-expanded="false" />
                                    <div class="dropdown-menu w-100">
                                        <div class="p-2 px-3 pt-1 searchlist-input">
                                            <input type="text"
                            ...
                            <div class="col-sm-6">
                                <div>
                                    ...
                                    <div class="input-step">
                                        ...
                                        <input type="number" class="product-quantity" value="2" min="0"
                                            max="100" readonly>
                                ...
                                <div class="col-sm-6">
                                    <div>
                                        ...
                                        <div class="input-step full-width">
                                            <button type="button" class="minus">–</button>
                                            <input type="number" class="product-quantity" value="4" min="0"
                                                max="100" readonly>
                                            <button type="button" class="plus">+</button>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    <div>
                                        ...
                                        <div class="input-step full-width light">
                                            <button type="button" class="minus">–</button>
                                            <input type="number" class="product-quantity" value="6" min="0"
                                                max="100" readonly>
                                            <button type="button" class="plus">+</button>
                                        </div>
                                    </div>
                        ...
                        <div class="row g-3">
                            <div class="col-lg-6">
                                <div>
                                    ...
                                    <input id="autoCompleteFruit" type="text" dir="ltr" spellcheck=false
                            ...
                            <div class="col-lg-6">
                                <div>
                                    ...
                                    <input id="autoCompleteCars" type="text" dir="ltr" spellcheck=false
                                        autocomplete="off" autocapitalize="off">
                                </div>
                            </div>
                            <!-- end col -->
...
@endsection
@section('script')
    <script src="{{ URL::asset('assets/libs/multi.js/multi.min.js') }}"></script>
    <script src="{{ URL::asset('assets/libs/@tarekraafat/autocomplete.js/autoComplete.min.js') }}"></script>
