    ...
    <div class="row">
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>data-simplebar</code> attribute and add <code>max-height: **px</code> to
                        set default scrollbar.</p>
                    ...
                    <div class="mx-n3">
                        <div data-simplebar data-simplebar-auto-hide="false" style="max-height: 220px;" class="px-3">
                            ...
                            <p>The languages only differ in their grammar, their pronunciation and their most common words.
                                ...
                                expensive translators. To achieve this, it would be necessary to have uniform grammar,
                                pronunciation and more common words.</p>
                            <p class="mb-0">Their separate existence is a myth. For science, music, sport, etc, Europe
                                uses the same vocabulary. The languages only differ in their grammar, their pronunciation
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">Use <code>data-simplebar-track="primary"</code> attribute to set primary
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1 text-muted">
                                                <p class="m-0">You have received <span
                                                        class="fw-semibold text-success">20</span> new messages in the
                                                    conversation</p>
                                            </div>
                                            <div class="flex-shrink-0 ms-2">
                                                <div class="fs-11 text-muted">
                ...
                <div class="col-xl-4 col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">Use <code>data-simplebar-track="success"</code> attribute to set success
                                color simplebar track.</p>
                ...
                <div class="col-xl-4 col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">Use <code>data-simplebar-track="info"</code> attribute to set info color
                                simplebar track.</p>
                ...
                <div class="col-xl-4 col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">Use <code>data-simplebar-track="warning"</code> attribute to set warning
                                color simplebar track.</p>
                ...
                <div class="col-xl-4 col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">Use <code>data-simplebar-track="danger"</code> attribute to set danger
                                color simplebar track.</p>
                ...
                <div class="col-xl-4 col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">Use <code>data-simplebar-track="dark"</code> attribute to set dark color
                                simplebar track.</p>
