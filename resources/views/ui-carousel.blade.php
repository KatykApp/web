    ...
    <div class="row">
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use<code> slide</code> class to set carousel with slides. Note the presence of the
                        <code>d-block</code> and <code>w-100</code> class on carousel images to prevent browser default
                        image alignment.</p>
                            ...
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item carousel-item-next carousel-item-start">
                                    <img class="d-block img-fluid mx-auto"
                                        src="{{ URL::asset('assets/images/small/img-1.jpg') }}" alt="First slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block img-fluid mx-auto"
                                        src="{{ URL::asset('assets/images/small/img-2.jpg') }}" alt="Second slide">
                                </div>
                                <div class="carousel-item active carousel-item-start">
                                    <img class="d-block img-fluid mx-auto"
                                        src="{{ URL::asset('assets/images/small/img-3.jpg') }}" alt="Third slide">
                                </div>
                            </div>
                        </div>
                    </div>
...
&lt;/div&gt;</code></pre>
        ...
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>carousel-control-prev</code> and <code>carousel-control-next</code>
                        class with &lt;button&gt; or &lt;a&gt; tag element to show carousel with control navigation.</p>
                    <div class="live-preview">
                        <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item active">
                                    <img class="d-block img-fluid mx-auto"
                                        src="{{ URL::asset('assets/images/small/img-4.jpg') }}" alt="First slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block img-fluid mx-auto"
                                        src="{{ URL::asset('assets/images/small/img-5.jpg') }}" alt="Second slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block img-fluid mx-auto"
                                        src="{{ URL::asset('assets/images/small/img-6.jpg') }}" alt="Third slide">
                                </div>
                            </div>
    ...
    <div class="row">
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>carousel-indicators</code> class with &lt;ol&gt; element to show
                        carousel with indicators.</p>
                    ...
                    <div class="live-preview">
                        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                            ...
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item">
                                    <img class="d-block img-fluid mx-auto"
                                        src="{{ URL::asset('assets/images/small/img-3.jpg') }}" alt="First slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block img-fluid mx-auto"
                                        src="{{ URL::asset('assets/images/small/img-2.jpg') }}" alt="Second slide">
                                ...
                                <div class="carousel-item active">
                                    <img class="d-block img-fluid mx-auto"
                                        src="{{ URL::asset('assets/images/small/img-1.jpg') }}" alt="Third slide">
                                </div>
                            </div>
                                ...
                                <div class="carousel-item">
                                    ...
                                    <div class="carousel-caption text-white-50">
                                        ...
                                        <p>You've probably heard that opposites attract. The same is true for fonts. Don't
                                            be afraid to combine font styles that are different but complementary.</p>
                                    </div>
                                </div>
                                <div class="carousel-item active">
                                    ...
                                    <div class="carousel-caption text-white-50">
                                        ...
                                        <p>Consistency piques people’s interest is that it has become more and more popular
                                            over the years, which is excellent.</p>
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <img src="{{ URL::asset('assets/images/small/img-9.jpg') }}" alt=""
                                        class="d-block img-fluid mx-auto">
                                    <div class="carousel-caption text-white-50">
                                        ...
                                        <p>Increase or decrease the letter spacing depending on the situation and try, try
                                            again until it looks right, and each letter.</p>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="row">
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>carousel-fade</code> class to the carousel to animate slides with a
...
&lt;/div&gt;
        ...
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>data-bs-interval=" "</code> to a carousel-item to change the amount of
                        time to delay between automatically cycling to the next item.</p>
                    <div class="live-preview">
                        <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active" data-bs-interval="10000">
                                    <img src="{{ URL::asset('assets//images/small/img-12.jpg') }}" class="d-block w-100"
                                        alt="First slide" />
                                </div>
                                <div class="carousel-item" data-bs-interval="2000">
                                    <img src="{{ URL::asset('assets/images/small/img-11.jpg') }}" class="d-block w-100"
                                        alt="two slide" />
                                </div>
                                <div class="carousel-item">
                                    <img src="{{ URL::asset('assets/images/small/img-10.jpg') }}" class="d-block w-100"
                                        alt="There slide" />
                                </div>
                            </div>
    ...
    <div class="row">
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Carousels support swiping left/right on touchscreen devices to move between
                        slides.
                        This can be disabled using the <code>data-bs-touch</code> attribute. The example below also does not
                        include the
                        <code>data-bs-ride attribute</code> and has <code>data-bs-interval="false"</code> so it doesn’t
                        autoplay.
                    </p>
                    <div class="live-preview">
                        <div id="carouselExampleControlsNoTouching" class="carousel slide" data-bs-touch="false"
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="{{ URL::asset('assets/images/small/img-9.jpg') }}" class="d-block w-100"
                                        alt="One Slide" />
                                </div>
                                <div class="carousel-item">
                                    <img src="{{ URL::asset('assets/images/small/img-8.jpg') }}" class="d-block w-100"
                                        alt="Two Slide" />
                                </div>
                                <div class="carousel-item">
                                    <img src="{{ URL::asset('assets/images/small/img-7.jpg') }}" class="d-block w-100"
                                        alt="Three Slide" />
                                </div>
                            </div>
                            <button class="carousel-control-prev" type="button"
...
&lt;/div&gt;</code></pre>
        ...
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>carousel-dark</code> class to the carousel for darker controls,
                    ...
                    <div class="live-preview">
                        <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active" data-bs-interval="10000">
                                    <img src="{{ URL::asset('assets/images/small/img-4.jpg') }}" class="d-block w-100"
                                        alt="One Slide">
                                    <div class="carousel-caption d-none d-md-block">
                                        <h5>Drawing a sketch</h5>
                                        <p>Too much or too little spacing, as in the example below, can make things
                                            unpleasant for the reader.</p>
                                    </div>
                                </div>
                                <div class="carousel-item" data-bs-interval="2000">
                                    <img src="{{ URL::asset('assets/images/small/img-5.jpg') }}" class="d-block w-100"
                                        alt="Two Slide">
                                    <div class="carousel-caption d-none d-md-block">
                                        <h5>Blue clock on a pastel background</h5>
                                        <p>In some designs, you might adjust your tracking to create a certain artistic
                                            effect asked them what graphic design tips they live.</p>
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <img src="{{ URL::asset('assets/images/small/img-6.jpg') }}" class="d-block w-100"
                                        alt="Three Slide">
                                    <div class="carousel-caption d-none d-md-block">
