            ...
            <div class="card card-height-100">
                ...
                <div class="card-body">
                    <div id="portfolio_donut_charts"
                        data-colors='["--vz-primary", "--vz-info", "--vz-warning", "--vz-success"]' class="apex-charts"
                        dir="ltr"></div>
                                ...
                                <div class="row align-items-end g-0">
                                    ...
                                    <div class="col-6">
                                        <div class="apex-charts crypto-widget"
                                            data-colors='["--vz-success" , "--vz-transparent"]' dir="ltr"
                                            id="bitcoin_sparkline_charts"></div>
                                    </div><!-- end col -->
                                </div><!-- end row -->
                            </div><!-- end card body -->
                        </div><!-- end card -->
                            ...
                            <div class="card-body">
                                ...
                                <div class="row align-items-end g-0">
                                    ...
                                    <div class="col-6">
                                        <div class="apex-charts crypto-widget"
                                            data-colors='["--vz-success", "--vz-transparent"]' dir="ltr"
                                            id="litecoin_sparkline_charts"></div>
                                    </div><!-- end col -->
                                </div><!-- end row -->
                            </div><!-- end card body -->
                        </div><!-- end card -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row align-items-end g-0">
                                    ...
                                    <div class="col-6">
                                        <div class="apex-charts crypto-widget"
                                            data-colors='["--vz-danger", "--vz-transparent"]' dir="ltr"
                                            id="binance_sparkline_charts"></div>
                                    </div><!-- end col -->
                                </div><!-- end row -->
                            </div><!-- end card body -->
                        </div><!-- end card -->
                            ...
                            <div class="card-body">
                                ...
                                <div class="row align-items-end g-0">
                                    ...
                                    <div class="col-6">
                                        <div class="apex-charts crypto-widget"
                                            data-colors='["--vz-success", "--vz-transparent"]' dir="ltr"
                                            id="tether_sparkline_charts"></div>
                                    </div><!-- end col -->
                                </div><!-- end row -->
                            </div><!-- end card body -->
                        </div><!-- end card -->
                        ...
                        <table class="table table-hover table-borderless table-centered align-middle table-nowrap mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>$53,914.025</td>
                                    <td>1.25634801</td>
                                    <td><a href="apps-crypto-buy-sell" class="btn btn-sm btn-soft-secondary">Trade</a>
                                    </td>
                                </tr><!-- end -->
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="me-2">
                                                <img src="{{ URL::asset('assets/images/svg/crypto-icons/doge.svg') }}"
                                                    alt="" class="avatar-xxs">
                                            </div>
                                            <div>
                    ...
                    <div data-simplebar style="height: 390px;">
                        <div class="p-3">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-shrink-0 text-end">
                                    <h6 class="mb-1 text-success">+0.04025745<span class="text-uppercase ms-1">Btc</span>
                                    </h6>
                            ...
                            <div class="d-flex align-items-center mt-3">
                                ...
                                <div class="flex-shrink-0 text-end">
                                    <h6 class="mb-1 text-muted">-0.09025182<span class="text-uppercase ms-1">Eth</span>
                                    </h6>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-shrink-0 text-end">
                                    <h6 class="mb-1 text-danger">-98.6025422<span class="text-uppercase ms-1">Dash</span>
                                    </h6>
                            ...
                            <div class="d-flex align-items-center mt-3">
                                ...
                                <div class="flex-shrink-0 text-end">
                                    <h6 class="mb-1 text-success">+0.07225912<span class="text-uppercase ms-1">Ltc</span>
                                    </h6>
