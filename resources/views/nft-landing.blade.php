                        ...
                        <div class="col-lg-8 col-sm-10">
                            <div class="text-center">
                                ...
                                <div class="hstack gap-2 justify-content-center">
                                    <a href="apps-nft-create" class="btn btn-primary">Create Own <i
                                            class="ri-arrow-right-line align-middle ms-1"></i></a>
                                    <a href="apps-nft-explore" class="btn btn-danger">Explore Now <i
                                            class="ri-arrow-right-line align-middle ms-1"></i></a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container">
                    ...
                    <div class="row g-4">
                        <div class="col-lg-4">
                            <div class="card text-center border shadow-none">
                                <div class="card-body py-5 px-4">
                                    <img src="{{ URL::asset('assets/images/nft/wallet/metamask.png') }}" alt=""
                                        height="55" class="mb-3 pb-2">
                                    <h5>Metamask</h5>
                                    <p class="text-muted pb-1">MetaMask is a popular cryptocurrency wallet known for its
                                        ease of use, availability on both desktops.</p>
                        ...
                        <div class="col-lg-4">
                            <div class="card text-center border shadow-none">
                                <div class="card-body py-5 px-4">
                                    <img src="{{ URL::asset('assets/images/nft/wallet/coinbase.png') }}" alt=""
                                        height="55" class="mb-3 pb-2">
                                    <h5>Coinbase Wallet</h5>
                                    <p class="text-muted pb-1">Coinbase Wallet is a self-custody wallet that gives you
                                        complete control of your crypto for your Wallet.</p>
                        ...
                        <div class="col-lg-4">
                            <div class="card text-center border shadow-none">
                                <div class="card-body py-5 px-4">
                                    <img src="{{ URL::asset('assets/images/nft/wallet/binance.png') }}" alt=""
                                        height="55" class="mb-3 pb-2">
                                    <h5>Binance</h5>
                                    <p class="text-muted pb-1">Binance is considered a safe exchange that allows user
                                        account protection via the use of Two Authentication.</p>
                                    <a href="#!" class="btn btn-soft-info">Connect Wallet</a>
                                </div>
                            </div>
                        </div><!-- end col -->
                        ...
                        <div class="col-lg-8">
                            <div class="text-center mb-5">
                                ...
                                <ul class="nav nav-pills filter-btns justify-content-center" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link fw-medium" type="button"
                                            data-filter="games">Games</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link fw-medium" type="button"
                                            data-filter="crypto-card">Crypto Card</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="card shadow-none">
                                <div class="card-body">
                                    <img src="{{ URL::asset('assets/images/nft/wallet.png') }}" alt=""
                                        class="avatar-sm">
                        ...
                        <div class="col-lg-3">
                            <div class="card shadow-none">
                                <div class="card-body">
                                    <img src="{{ URL::asset('assets/images/nft/money.png') }}" alt=""
                                        class="avatar-sm">
                        ...
                        <div class="col-lg-3">
                            <div class="card shadow-none">
                                <div class="card-body">
                                    <img src="{{ URL::asset('assets/images/nft/add.png') }}" alt=""
                                        class="avatar-sm">
                        ...
                        <div class="col-lg-3">
                            <div class="card shadow-none">
                                <div class="card-body">
                                    <img src="{{ URL::asset('assets/images/nft/sell.png') }}" alt=""
                                        class="avatar-sm">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <h5 class="mb-0 fs-16"><a href="#!">Artwork <span
                                                            class="badge bg-success-subtle text-success">206</span></a>
                                                </h5>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <h5 class="mb-0 fs-16"><a href="#!">Crypto Card <span
                                                            class="badge bg-success-subtle text-success">743</span></a>
                                                </h5>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <h5 class="mb-0 fs-16"><a href="#!">Music <span
                                                            class="badge bg-success-subtle text-success">679</span></a>
                                                </h5>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <h5 class="mb-0 fs-16"><a href="#!">Games <span
                                                            class="badge bg-success-subtle text-success">341</span></a>
                                                </h5>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <h5 class="mb-0 fs-16"><a href="#!">Photography <span
                                                            class="badge bg-success-subtle text-success">1452</span></a>
                                                </h5>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-12">
                            <div class="d-flex align-items-center mb-5">
                                ...
                                <a href="apps-nft-explore" class="btn btn-primary">View All <i
                                        class="ri-arrow-right-line align-bottom"></i></a>
                            </div>
                        </div>
                    </div><!-- end row -->
                            ...
                            <div class="card explore-box card-animate border">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <h6 class="fs-16 mb-0"><a href="apps-nft-item-details">Patterns arts &amp;
                                                culture</a></h6>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card explore-box card-animate border">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <h6 class="fs-16 mb-0"><a href="apps-nft-item-details">Long-tailed macaque</a>
                                        </h6>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 mt-4">
                            <div>
                                ...
                                <div class="mt-4">
                                    ...
                                    <p>You can assets any type of web application like eCommerce, CRM, CMS, Project
