...
@section('title') Candidate Grid View @endsection
@section('content')
@component('components.breadcrumb')
@slot('li_1') Candidate Lists @endslot
@slot('title') Grid View @endslot
@endcomponent
...
<script src="{{URL::asset('assets/js/pages/job-candidate-grid.init.js')}}"></script>
