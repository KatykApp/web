        ...
        <div class="col-xxl-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted mb-4">Use few flex utilities that allow even more flexibility and customization
                        than before.</p>

                    <div class="live-preview">
                        <div class="d-flex align-items-start text-muted mb-4">
                            <div class="flex-shrink-0 me-3">
                                <img src="{{ URL::asset('assets/images/users/avatar-2.jpg') }}" class="avatar-sm rounded"
                                    alt="...">
                            </div>
                        ...
                        <div class="d-flex align-items-start text-muted mb-4">
                            ...
                            <div class="flex-shrink-0 ms-3">
                                <img src="{{ URL::asset('assets/images/users/avatar-3.jpg') }}" class="avatar-sm rounded"
                                    alt="...">
                            </div>
                        </div>
...
&lt;/div&gt;</code></pre>
        ...
        <div class="col-xxl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted mb-4">Media objects can be infinitely nested, though we suggest you stop at some
                        point. Place nested <code>d-flex align-items-start</code> within the <code>flex-grow-1</code> of a
                        parent media object.</p>
                    <div class="live-preview">
                        <div class="d-flex align-items-start text-muted mb-4">
                            <div class="flex-shrink-0 me-3">
                                <img src="{{ URL::asset('assets/images/users/avatar-2.jpg') }}" class="avatar-sm rounded"
                        ...
                        <div class="d-flex align-items-start text-muted">
                            <div class="flex-shrink-0 me-3">
                                <img src="{{ URL::asset('assets/images/users/avatar-4.jpg') }}" class="avatar-sm rounded"
                                    alt="...">
                            </div>
                            <div class="flex-grow-1">
                                <h5 class="fs-14">Media heading</h5>
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted mb-4">The images or other media can be aligned top, middle, or bottom. The default
                        is top aligned.</p>
                    ...
                    <div class="live-preview">
                        <div class="d-flex align-items-start text-muted mb-4">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <p class="mb-1">Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque
                        ...
                        <div class="d-flex align-items-center text-muted mb-4">
                            <div class="flex-shrink-0 me-3">
                                <img src="{{ URL::asset('assets/images/users/avatar-6.jpg') }}" class="avatar-sm rounded"
                                    alt="...">
                            </div>
                        ...
                        <div class="d-flex align-items-end text-muted">
                            <div class="flex-shrink-0 me-3">
                                <img src="{{ URL::asset('assets/images/users/avatar-8.jpg') }}" class="avatar-sm rounded"
                                    alt="...">
                            </div>
