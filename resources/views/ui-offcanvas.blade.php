                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                ...
                                                <p class="text-muted mb-2"><span class="text-danger">2 days left</span>
                                                    notification to submit the monthly sales report. <a
                                                        ...
                                                        class="link-warning text-decoration-underline">Reports assetser</a>
                                                </p>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>offcanvas-top</code>, <code>offcanvas-end</code>,
                        <code>offcanvas-bottom</code>, or <code>offcanvas-start</code> to offcanvas class to set different
                        Offcanvas Placement.</p>
                    <div class="live-preview">
