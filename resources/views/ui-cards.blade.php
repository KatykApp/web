...
@section('content')
    ...
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">At missed advice my it no sister. Miss told ham dull knew see she spot near can.
                        Spirit her entire her called.</p>
                    <div class="text-end">
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card">
                <img class="card-img-top img-fluid" src="{{ URL::asset('assets/images/small/img-2.jpg') }}"
                    alt="Card image cap">
                <div class="card-body">
                    ...
                    <p class="card-text mb-0">Whether article spirits new her covered hastily sitting her. Money witty books
                        nor son add. Chicken age had evening believe but proceed pretend mrs.</p>
                </div>
                <div class="card-footer">
                    ...
                    <a href="javascript:void(0);" class="card-link link-success">Bookmark <i
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="card-text">Objectively pursue diverse catalysts for change for interoperable meta-services.
                        Distinctively re-engineer revolutionary meta-services.</p>
                </div>
                <div class="card-footer">
                    <a href="javascript:void(0);" class="card-link link-secondary">Read More <i
                            class="ri-arrow-right-s-line ms-1 align-middle lh-1"></i></a>
            ...
            <div class="row">
                <div class="col-xxl-4 col-lg-6">
                    <div class="card card-body">
                        ...
                        <p class="card-text text-muted">Send a link to apply on mobile device. Appropriately communicate
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text text-muted mb-0">A business consulting agency is involved in the planning,
                                implementation, and education of businesses. Miss told ham dull knew see she spot near can.
                                Spirit her entire her called.</p>
                        </div>
                        <div class="card-footer">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text text-muted mb-0">Intrinsically incubate intuitive opportunities and
                                real-time potentialities for change for interoperable meta-services itself or distract the
                                viewer's attention from the layout.</p>
                        </div>
                        <div class="card-footer">
                            <a href="javascript:void(0);" class="link-success float-end">Payment Now <i
                                    class="ri-arrow-right-s-line align-middle ms-1 lh-1"></i></a>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <blockquote class="card-blockquote mb-0">
                                <p class="text-muted mb-2">There are many variations of passages of Lorem Ipsum available.
                                </p>
                                <figure class="mb-0">
                                    ...
                                    <figcaption class="blockquote-footer fs-13 text-end mb-0">
                                        Creative Agency<cite title="Source Title" class="text-primary fw-semibold"> Alice
                                            Mellor</cite>
                                    </figcaption>
                                </figure>
                            </blockquote>
    ...
    <div class="row">
        <div class="col-xl-4">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-3"><i class="ri-user-3-fill align-middle me-1 text-muted"></i> Natasha Carey
                    </h4>
                    <p class="text-muted">Too much or too little spacing, as in the example below, can make things
                        unpleasant for the reader. The goal is to make your text as comfortable to read as possible.</p>
                    <p class="text-muted mb-0">This response is important for our ability to learn from mistakes, but it
                        alsogives rise to self-criticism.</p>
                </div>
                <div class="card-footer text-center">
                    <a href="javascript:void(0);" class="link-secondary">View All Notification (2) <i
                            class="ri-arrow-right-s-line align-middle ms-1 lh-1"></i></a>
                </div>
            </div>
        </div><!-- end col -->
                ...
                <div class="card-body">
                    <p class="text-muted">
                        Contrary to popular belief, you don’t have to work endless nights and hours to create a <a
                            href="javascript:void(0);" class="text-decoration-underline"><b>Fantastic Design</b></a> by
                        using complicated 3D elements. Flat design is your friend. Remember that. And the great thing about
                        flat design is that it has become more and more popular over the years.
                    </p>
                    <p class="text-muted mb-0">In some designs, you might adjust your tracking to create a certain artistic
                        effect.</p>
                </div>
            </div>
        </div><!-- end col -->
        <div class="col-xl-4">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">After gathering lots of different opinions and graphic design basics, I came up
                        with a list of 30 graphic design tips that you can start implementing. Each design is a new, unique
                        piece of art birthed into this world.</p>
                ...
                <div class="card-footer text-center">
                    <ul class="list-inline mb-0">
                        <li class="list-inline-item">
                            <a href="javascript:void(0);" class="lh-1 align-middle link-secondary"><i
                                    class="ri-facebook-fill"></i></a>
                        </li>
                        <li class="list-inline-item">
                            <a href="javascript:void(0);" class="lh-1 align-middle link-success"><i
                                    class="ri-whatsapp-line"></i></a>
                        </li>
                        <li class="list-inline-item">
                            <a href="javascript:void(0);" class="lh-1 align-middle link-primary"><i
                                    class="ri-linkedin-fill"></i></a>
                        </li>
                        <li class="list-inline-item">
                            <a href="javascript:void(0);" class="lh-1 align-middle link-danger"><i
                                    class="ri-slack-fill"></i></a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="card-body collapse show" id="collapseexample1">
                    <div class="d-flex">
                        ...
                        <div class="flex-grow-1 ms-2 text-muted">
                            ...
                            revealed when the user activates.
                        </div>
                    </div>
                    <div class="d-flex mt-2">
                        ...
                        <div class="flex-grow-1 ms-2 text-muted">
                            ...
                            reader. The goal is to make your text as comfortable to read as possible.
                        </div>
                    </div>
                    <div class="d-flex mt-2">
                        <div class="flex-shrink-0">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="row">
                <div class="col-xxl-4 col-lg-6">
                    <div class="card card-overlay">
                        <img class="card-img img-fluid" src="{{ URL::asset('assets/images/small/img-12.jpg') }}"
                            alt="Card image">
                        <div class="card-img-overlay p-0 d-flex flex-column">
                            ...
                            <div class="card-body">
                                <p class="card-text text-white mb-2">Each design is a new, unique piece of art birthed into
                                    this world, and while you have the opportunity to be creative and make your unpleasant
                                    for the reader. </p>
                                <p class="card-text">
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card card-overlay">
                        <img class="card-img img-fluid" src="{{ URL::asset('assets/images/small/img-1.jpg') }}"
                            alt="Card image">
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card card-overlay">
                        <img class="card-img img-fluid" src="{{ URL::asset('assets/images/small/img-5.jpg') }}"
                            alt="Card image">
            ...
            <div class="row">
                <div class="col-xxl-4 col-lg-6">
                    <div class="card">
                        <img class="card-img-top img-fluid" src="{{ URL::asset('assets/images/small/img-6.jpg') }}"
                            alt="Card image cap">
                        <div class="card-body">
                            ...
                            <p class="card-text text-muted"> Exercitation +1 labore velit, blog sartorial PBR leggings next
                                level wes anderson artisan four loko farm-to-table craft beer twee. commodo enim craft beer
                                mlkshk aliquip jean shorts ullamco.</p>
                            <p class="card-text">
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card">
                        ...
                        <img class="card-img-bottom img-fluid" src="{{ URL::asset('assets/images/small/img-7.jpg') }}"
                            alt="Card image cap">
                    </div>
                </div><!-- end col -->
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card">
                        <img class="card-img-top img-fluid" src="{{ URL::asset('assets/images/small/img-11.jpg') }}"
                            alt="Card image cap">
                        <div class="card-header">
                            <h4 class="card-title mb-0">A day in the of a professional fashion designer</h4>
                        </div>
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="card-text text-muted"> Exercitation +1 labore velit, blog sartorial PBR leggings next
                                level wes anderson artisan four loko farm-to-table craft beer twee. ommodo enim craft beer
                                mlkshk aliquip jean shorts ullamco.</p>
                            <p class="card-text mb-0">
                                Last updated 3 mins ago
                            </p>
                        </div>
                        <img class="card-img-bottom img-fluid" src="{{ URL::asset('assets/images/small/img-11.jpg') }}"
                            alt="Card image cap">
                    </div>
                </div><!-- end col -->
            </div>
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-4">
                                <img class="rounded-end img-fluid h-100 object-fit-cover"
                                    src="{{ URL::asset('assets/images/small/img-4.jpg') }}" alt="Card image">
                            </div>
                        </div>
                    </div><!-- end card -->
                </div><!-- end col -->
                ...
                <div class="col-xxl-6">
                    <div class="card">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img class="rounded-start img-fluid h-100 object-fit-cover"
                                    src="{{ URL::asset('assets/images/small/img-9.jpg') }}" alt="Card image">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    <h5 class="card-title mb-2">Give your text a good structure</h5>
                                    <p class="card-text text-muted mb-0">For that very reason, I went on a quest and spoke
                                        to many different professional graphic designers and asked them what graphic design
                                        tips they live.</p>
                                </div>
                                <div class="card-footer">
                                    <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
                ...
                <div class="col-xxl-6">
                    <div class="card">
                        <div class="row g-0">
                            ...
                            <div class="col-md-4">
                                <img class="rounded-end img-fluid h-100 object-fit-cover"
                                    src="{{ URL::asset('assets/images/small/img-2.jpg') }}" alt="Card image">
                            </div>
                        </div>
                    </div><!-- end card -->
                </div><!-- end col -->
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <p class="card-text"><span class="fw-medium">Jeffrey Montgomery</span> (Graphic
                                        Designer) started a new conversation.</p>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer">
                            <div class="text-center">
                                <a href="javascript:void(0);" class="link-light">Connect Now <i
                    ...
                    <div class="card card-success">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <p class="card-text"><span class="fw-medium">Charles Dickens</span> (Financial
                                        Analyst) started a new conversation.</p>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer">
                    ...
                    <div class="card card-info">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <p class="card-text"><span class="fw-medium">Oliver Phillips</span> (UI/UX Designer)
                                        started a new conversation.</p>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer">
    ...
    <div class="row">
        ...
        <div class="col-xxl-4">
            <div class="card card-light">
                ...
                <div class="card-footer">
                    <div class="text-center">
                        <a href="javascript:void(0);" class="link-dark">Connect Now <i
                                class="ri-arrow-right-s-line align-middle lh-1"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xxl-4">
                    <div class="card border card-border-primary">
                        ...
                        <div class="card-body">
                            <p class="card-text">Whether article spirits new her covered hastily sitting her. Money witty
                                books nor son add assets on the card Chicken age had evening believe but proceed pretend mrs.
                            </p>
                            <div class="text-end">
                ...
                <div class="col-xxl-4">
                    <div class="card border card-border-success">
                        <div class="card-header">
                            ...
                            <h6 class="card-title mb-0">Quality Forcast <span
                                    class="badge bg-success align-middle fs-10">Excellent</span></h6>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="text-end">
                                <a href="javascript:void(0);" class="link-success fw-medium">Read More <i
                                        class="ri-arrow-right-line align-middle"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xxl-4">
                    <div class="card border card-border-info">
                        <div class="card-header">
                            <h6 class="card-title mb-0">Check your E-mails <span
                                    class="badge bg-info align-middle fs-10">In Process</span></h6>
                        </div>
                        <div class="card-body">
                            <p class="card-text">They all have something to say beyond the words on the page. They can come
                                across as casual or neutral, exotic or graphic. Cosby sweater eu banh mi, qui irure terry
                                richardson ex squid.</p>
                            <div class="text-end">
                                <a href="javascript:void(0);" class="link-info fw-medium">Read More <i
                                        class="ri-arrow-right-line align-middle"></i></a>
                            </div>
                        </div>
                    </div>
    ...
    <div class="row">
        <div class="col-xxl-4">
            <div class="card border card-border-warning">
                <div class="card-header">
                    <h6 class="card-title mb-0">Check your Payment <span
                            class="badge bg-warning align-middle fs-10">Pending</span></h6>
                </div>
                <div class="card-body">
                    <p class="card-text">They all have something to say beyond the words on the page. They can come across
                        as casual or neutral, exotic or graphic. Cosby sweater eu banh mi, qui irure terry richardson ex
                        squid.</p>
                    <div class="text-end">
                        <a href="javascript:void(0);" class="link-warning fw-medium">Read More <i
                                class="ri-arrow-right-line align-middle"></i></a>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xxl-4">
            <div class="card border card-border-danger">
                <div class="card-header">
                    <h6 class="card-title mb-0">Your Ordered Cancel <span
                            class="badge bg-danger align-middle fs-10">Cancel</span></h6>
                </div>
                <div class="card-body">
                    <p class="card-text">They all have something to say beyond the words on the page. They can come across
                        as casual or neutral, exotic or graphic. Cosby sweater eu banh mi, qui irure terry richardson ex
                        squid.</p>
                    <div class="text-end">
                        <a href="javascript:void(0);" class="link-danger fw-medium">Read More <i
                                class="ri-arrow-right-line align-middle"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="card border card-border-dark">
                ...
                <div class="card-body">
                    <p class="card-text">They all have something to say beyond the words on the page. They can come across
                        ...
                        squid.</p>
                    <div class="text-end">
                        <a href="javascript:void(0);" class="link-dark fw-medium">Read More <i
                                class="ri-arrow-right-line align-middle"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="card border card-border-secondary">
                ...
                <div class="card-body">
                    <p class="card-text">They all have something to say beyond the words on the page. They can come across
                        ...
                        squid.</p>
                    <div class="text-end">
                        <a href="javascript:void(0);" class="link-secondary fw-medium">Read More <i
                                class="ri-arrow-right-line align-middle"></i></a>
                    </div>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card-group">
                ...
                <div class="card mb-4">
                    <img class="card-img-top img-fluid" src="{{ URL::asset('assets/images/small/img-5.jpg') }}"
                        alt="Card image cap" />
                    <div class="card-body">
    ...
    <div class="row g-3">
        ...
        <div class="col-xxl col-6">
            <div class="card h-100">
                <img class="card-img-top img-fluid" src="{{ URL::asset('assets/images/small/img-10.jpg') }}"
                    alt="Card image cap" />
                <div class="card-body">
                    <h4 class="card-title">Give your text a good structure?</h4>
                    <p class="card-text">This is a wider card with supporting text below as
            ...
            <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Exercitation +1 labore velit, blog sartorial PBR leggings next level wes anderson
                        artisan four loko farm-to-table craft beer twee. ommodo enim craft beer mlkshk aliquip jean shorts
                        ullamco.</p>
                </div>
                <div class="card-footer">
                    <p class="card-text">
        ...
        <div class="col-sm-12">
            ...
            <div class="row" data-masonry='{"percentPosition": true }'>
                <div class="col-sm-6 col-lg-4">
                    <div class="card">
                        <img src="{{ URL::asset('assets/images/small/img-3.jpg') }}" class="card-img-top"
                            alt="..." />
                        <div class="card-body">
                ...
                <div class="col-xl-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Some quick example text to assets on the card title and make up the bulk
                        ...
                        <div class="card-body">
                            <div class="row g-0 bg-light position-relative">
                                ...
                                <div class="col-md-7 p-4">
                                    ...
                                    <p>Another instance of placeholder content for this other custom component. It is
