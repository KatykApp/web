            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted">Use
                        <code>rounded</code> class and <code>rounded-circle</code> class to show an image with a round
        ...
        <div class="col-xxl-6">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted">Use <code>img-thumbnail</code> class to give an image
...
<code>&lt;img src=&quot;assets/images/users/avatar-8.jpg&quot; alt=&quot;&quot; class=&quot;rounded-circle avatar-xl&quot;&gt;</code></pre>
                    </div>
                </div><!-- end card-body -->
            </div><!-- end card -->
        </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>avatar-xxs, avatar-xs,avatar-sm,avatar-md,avatar-lg,avatar-xl</code>
                        class to set different avatar content.</p>
                        ...
                        <div class="row g-3">
                            <div class="col-xxl-2 col-md-4 col-6">
                                <div class="avatar-xxs mt-3">
                                    <div class="avatar-title rounded bg-primary-subtle text-primary fs-10">
                                        XXS
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-2 col-md-4 col-6">
                                <div class="avatar-sm mt-3">
                                    <div class="avatar-title rounded bg-success-subtle text-success fs-14">
                                        SM
                                    </div>
                                </div>
                            </div>
                            <div class="col-xxl-2 col-md-4 col-6">
                                <div class="avatar-md mt-3">
                                    <div class="avatar-title rounded bg-info-subtle text-info fs-16">
                                        MD
                                    </div>
                                </div>
                            </div>
                            <div class="col-xxl-2 col-md-4 col-6">
                                <div class="avatar-lg mt-3">
                                    <div class="avatar-title rounded bg-warning-subtle text-warning fs-20">
                                        LG
                                    </div>
                                </div>
                            </div>
                            <div class="col-xxl-2 col-md-4 col-6">
                                <div class="avatar-xl mt-3">
                                    <div class="avatar-title rounded bg-danger-subtle text-danger fs-22">
                                        XL
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mt-lg-0 mt-3">
                                    <p class="text-muted">Use <code>avatar-group</code> class to show avatar images with
                                        the group.</p>
                            ...
                            <div class="col-lg-6">
                                <div class="mt-lg-0 mt-3">
                                    <p class="text-muted">Use <code>avatar-group</code> class with
                                        <code>data-bs-toggle="tooltip"</code> to show avatar group images with tooltip.</p>
                                    <div class="avatar-group">
        ...
        <div class="col-xl-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="card-title-desc text-muted">Responsive Images with <code>img-fluid,max-width: 100%; and
                            height: auto;</code> to the image so that it scales with the parent width.</p>
