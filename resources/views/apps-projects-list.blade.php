                ...
                <div class="card-body">
                    ...
                    <div class="py-3">
                        ...
                        <div class="d-flex align-items-center mt-3">
                            ...
                            <div class="avatar-group">
                                <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip"
                                    data-bs-trigger="hover" data-bs-placement="top" title="Chet Diaz">
                                    <div class="avatar-xxs">
                                        <div class="avatar-title rounded-circle bg-info">
                                            C
                                        </div>
                    ...
                    <div>
                        ...
                        <div class="progress progress-sm animated-progress">
                            <div class="progress-bar bg-success" role="progressbar" aria-valuenow="41" aria-valuemin="0"
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div>
                        ...
                        <div class="progress progress-sm animated-progress">
                            <div class="progress-bar bg-success" role="progressbar" aria-valuenow="35" aria-valuemin="0"
        ...
        <div class="col-xxl-3 col-sm-6 project-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="py-3">
                        <h5 class="fs-14 mb-3"><a href="apps-projects-overview" class="text-body">Kanban
                                Board</a></h5>
                        <div class="row gy-3">
                            <div class="col-6">
                                <div>
        ...
        <div class="col-xxl-3 col-sm-6 project-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="py-3">
                        <h5 class="mb-3 fs-14"><a href="apps-projects-overview" class="text-body">Ecommerce
                                app</a></h5>
                        <div class="row gy-3">
                            <div class="col-6">
                                <div>
        ...
        <div class="col-xxl-3 col-sm-6 project-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="py-3">
                        <h5 class="mb-3 fs-14"><a href="apps-projects-overview" class="text-body">Redesign -
                                Landing page</a></h5>
                        <div class="row gy-3">
                            <div class="col-6">
                                <div>
