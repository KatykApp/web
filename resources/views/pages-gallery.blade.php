                        ...
                        <div class="col-lg-12">
                            <div class="text-center">
                                <ul class="list-inline categories-filter animation-nav" id="filter">
                                    ...
                                    <li class="list-inline-item"><a class="categories" data-filter=".project">Project</a>
                                    </li>
                            ...
                            <div class="row gallery-wrapper">
                                ...
                                <div class="element-item col-xxl-3 col-xl-4 col-sm-6 photography"
                                    ...
                                    <div class="gallery-box card">
                                        <div class="gallery-container">
                                            <a class="image-popup" href="{{ URL::asset('assets/images/small/img-2.jpg') }}"
                                                title="">
                                                <img class="gallery-img img-fluid mx-auto"
                                ...
                                <div class="element-item col-xxl-3 col-xl-4 col-sm-6 project development"
                                    ...
                                    <div class="gallery-box card">
                                        <div class="gallery-container">
                                            <a class="image-popup" href="{{ URL::asset('assets/images/small/img-3.jpg') }}"
                                                title="">
                                                <img class="gallery-img img-fluid mx-auto"
                                ...
                                <div class="element-item col-xxl-3 col-xl-4 col-sm-6 project designing"
                                    ...
                                    <div class="gallery-box card">
                                        <div class="gallery-container">
                                            <a class="image-popup" href="{{ URL::asset('assets/images/small/img-4.jpg') }}"
                                                title="">
                                                <img class="gallery-img img-fluid mx-auto"
                                ...
                                <div class="element-item col-xxl-3 col-xl-4 col-sm-6 project designing"
                                    ...
                                    <div class="gallery-box card">
                                        <div class="gallery-container">
                                            <a class="image-popup" href="{{ URL::asset('assets/images/small/img-5.jpg') }}"
                                                title="">
                                                <img class="gallery-img img-fluid mx-auto"
                                ...
                                <div class="element-item col-xxl-3 col-xl-4 col-sm-6 photography"
                                    ...
                                    <div class="gallery-box card">
                                        <div class="gallery-container">
                                            <a class="image-popup"
                                                href="{{ URL::asset('assets/images/small/img-6.jpg') }}" title="">
                                                <img class="gallery-img img-fluid mx-auto"
                                ...
                                <div class="element-item col-xxl-3 col-xl-4 col-sm-6 project designing development"
                                    ...
                                    <div class="gallery-box card">
                                        <div class="gallery-container">
                                            <a class="image-popup"
                                                href="{{ URL::asset('assets/images/small/img-7.jpg') }}" title="">
                                                <img class="gallery-img img-fluid mx-auto"
                                ...
                                <div class="element-item col-xxl-3 col-xl-4 col-sm-6 photography"
                                    ...
                                    <div class="gallery-box card">
                                        <div class="gallery-container">
                                            <a class="image-popup"
                                                href="{{ URL::asset('assets/images/small/img-8.jpg') }}" title="">
                                                <img class="gallery-img img-fluid mx-auto"
                                ...
                                <div class="element-item col-xxl-3 col-xl-4 col-sm-6 project designing development"
                                    ...
                                    <div class="gallery-box card">
                                        <div class="gallery-container">
                                            <a class="image-popup"
                                                href="{{ URL::asset('assets/images/small/img-9.jpg') }}" title="">
                                                <img class="gallery-img img-fluid mx-auto"
                                                    src="{{ URL::asset('assets/images/small/img-9.jpg') }}"
                                                    alt="" />
                                                <div class="gallery-overlay">
                                                    <h5 class="overlay-caption">Dramatic clouds at the Golden Gate Bridge
                                                    </h5>
                                                </div>
                                            </a>
                                        </div>
                                ...
                                <div class="element-item col-xxl-3 col-xl-4 col-sm-6 project designing"
                                    ...
                                    <div class="gallery-box card">
                                        <div class="gallery-container">
                                            <a class="image-popup"
                                                href="{{ URL::asset('assets/images/small/img-10.jpg') }}" title="">
                                                <img class="gallery-img img-fluid mx-auto"
                                ...
                                <div class="element-item col-xxl-3 col-xl-4 col-sm-6 photography"
                                    ...
                                    <div class="gallery-box card">
                                        <div class="gallery-container">
                                            <a class="image-popup"
                                                href="{{ URL::asset('assets/images/small/img-11.jpg') }}" title="">
                                                <img class="gallery-img img-fluid mx-auto"
                                ...
                                <div class="element-item col-xxl-3 col-xl-4 col-sm-6 photography"
                                    ...
                                    <div class="gallery-box card">
                                        <div class="gallery-container">
                                            <a class="image-popup"
                                                href="{{ URL::asset('assets/images/small/img-12.jpg') }}" title="">
                                                <img class="gallery-img img-fluid mx-auto"
                                                    src="{{ URL::asset('assets/images/small/img-12.jpg') }}"
                                                    alt="" />
                                                <div class="gallery-overlay">
                                                    <h5 class="overlay-caption">A mix of friends and strangers heading off
                                                        to find an adventure.</h5>
                                                </div>
                                            </a>
                                        </div>
