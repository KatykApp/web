                    ...
                    <div class="live-preview">
                        <div>
                            <div>
                                ...
                                <p class="text-muted">Use <code>type="range"</code> attribute and <code>form-range</code>
                                    class to create a deafult range.</p>
                                <!-- Default Range -->
                            ...
                            <div class="mt-4">
                                ...
                                <p class="text-muted">Use <code>disabled</code> attribute on an input to give it a grayed
                            ...
                            <div class="mt-4">
                                ...
                                <p class="text-muted">By default, range inputs “snap” to integer values. To change this, you
                                    can specify a step value. In the example below, we double the number of steps by using
                                    <code>step="0.5"</code> attribute.</p>
                        ...
                        <div class="row mt-4">
                            <div class="col-lg-6">
                                <div class="mt-4">
                                    ...
                                    <p class="text-muted mb-4">Use <code>data-slider-style="square"</code> attribute to
                                        set square shape rangeslider.</p>
