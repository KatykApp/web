    ...
    <div class="row dash-nft">
                    ...
                    <div class="card card-height-100">
                        <div class="card-body">
                            ...
                            <div class="mt-4 pt-1">
                                ...
                                <p class="mt-4 mb-0 text-muted"><span class="badge bg-danger-subtle text-danger mb-0 me-1">
                                        <i class="ri-arrow-down-line align-middle"></i> 3.96 % </span> vs. previous month
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card card-height-100">
                        <div class="card-body">
                            ...
                            <div class="mt-4 pt-1">
                                ...
                                <p class="mt-4 mb-0 text-muted"><span class="badge bg-success-subtle text-success mb-0"> <i
                                    ...
                                    <div class="border-start p-4 h-100 d-flex flex-column">
                                        ...
                                        <div class="w-100">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="dropdown">
                                                    <a href="javascript:void(0);" class="align-middle text-muted"
                                                        role="button" id="dropdownMenuButton5" data-bs-toggle="dropdown"
                                                        aria-expanded="false">
                                            ...
                                            <p class="text-muted">NFT art is a digital asset that is collectable, unique,
                                                and non-transferrable, Cortes explained Every NFT is unique duplicated.</p>
                                            ...
                                            <div class="row mt-4 pt-2">
                                                <div class="col">
                                                    <a href="apps-nft-item-details" class="btn btn-primary w-100">View
                                                        Details</a>
                                                </div>
                                                <div class="col">
        ...
        <div class="col-xxl-3">
            <div class="card">
                ...
                <div>
                    <div id="market-overview" data-colors='["--vz-success", "--vz-warning"]' class="apex-charts mt-n4">
                    </div>
                </div>
            </div>
                    ...
                    <div class="table-responsive table-card">
                        <div data-simplebar style="max-height: 365px;">
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item list-group-item-action">
                                    <div class="d-flex align-items-center">
                                        <img src="{{ URL::asset('assets/images/nft/img-04.jpg') }}" alt=""
                                            class="avatar-xs object-fit-cover rounded-circle">
                                        <div class="ms-3 flex-grow-1">
                                            <a href="#!">
                    ...
                    <div class="swiper-slide">
                        <div class="card explore-box card-animate rounded">
                            ...
                            <div class="card-body">
                                <p class="fw-medium mb-0 float-end"><i class="mdi mdi-heart text-danger align-middle"></i>
                                    19.29k </p>
                                <h5 class="mb-1"><a href="apps-nft-item-details">Filtered Portrait</a></h5>
                    ...
                    <div class="swiper-slide">
                        <div class="card explore-box card-animate rounded">
                            ...
                            <div class="card-body">
                                <p class="fw-medium mb-0 float-end"><i class="mdi mdi-heart text-danger align-middle"></i>
                                    8.42k </p>
                                <h5 class="mb-1"><a href="apps-nft-item-details">Patterns Arts & Culture</a></h5>
                                <p class="text-muted mb-0">Artwork</p>
                            </div>
                            <div class="card-footer border-top border-top-dashed">
                                <div class="d-flex align-items-center">
                            ...
                            <table class="table table-borderless align-middle">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div id="mini-chart-1" data-colors='["--vz-danger"]' class="apex-charts"
                                                dir="ltr"></div>
                                        </td>
                                        <td class="text-end">
                                            <a href="#!">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div id="mini-chart-2" data-colors='["--vz-danger"]' class="apex-charts"
                                                dir="ltr"></div>
                                        </td>
                                        <td class="text-end">
                                            <a href="#!">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div id="mini-chart-3" data-colors='["--vz-danger"]' class="apex-charts"
                                                dir="ltr"></div>
                                        </td>
                                        <td class="text-end">
                                            <a href="#!">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div id="mini-chart-4" data-colors='["--vz-success"]' class="apex-charts"
                                                dir="ltr"></div>
                                        </td>
                                        <td class="text-end">
                                            <a href="#!">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div id="mini-chart-5" data-colors='["--vz-success"]' class="apex-charts"
                                                dir="ltr"></div>
                                        </td>
                                        <td class="text-end">
                                            <a href="#!">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div id="mini-chart-6" data-colors='["--vz-danger"]' class="apex-charts"
                                                dir="ltr"></div>
                                        </td>
                                        <td class="text-end">
                                            <a href="#!">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div id="mini-chart-7" data-colors='["--vz-success"]' class="apex-charts"
                                                dir="ltr"></div>
                                        </td>
                                        <td class="text-end">
                                            <a href="#!">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div id="mini-chart-8" data-colors='["--vz-danger"]' class="apex-charts"
                                                dir="ltr"></div>
                                        </td>
                                        <td class="text-end">
                                            <a href="#!">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                <h6 class="mb-1"><a href="apps-nft-item-details">Abstract Face
                                                        Painting</a></h6>
                                                <p class="text-muted mb-0"> Artworks</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td><img src="{{ URL::asset('assets/images/svg/crypto-icons/btc.svg') }}"
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                <h6 class="mb-1"><a href="apps-nft-item-details">Long-tailed Macaque</a>
                                                </h6>
                                                <p class="text-muted mb-0">Games</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td><img src="{{ URL::asset('assets/images/svg/crypto-icons/ltc.svg') }}"
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                <h6 class="mb-1"><a href="apps-nft-item-details">Robotic Body Art</a>
                                                </h6>
                                                <p class="text-muted mb-0">Photography</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td><img src="{{ URL::asset('assets/images/svg/crypto-icons/etc.svg') }}"
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                <h6 class="mb-1"><a href="apps-nft-item-details">Smillevers Crypto</a>
                                                </h6>
                                                <p class="text-muted mb-0">Artworks</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td><img src="{{ URL::asset('assets/images/svg/crypto-icons/dash.svg') }}"
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                <h6 class="mb-1"><a href="apps-nft-item-details">Creative Filtered
                                                        Portrait</a></h6>
                                    ...
                                    <td><img src="{{ URL::asset('assets/images/svg/crypto-icons/bnb.svg') }}"
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                <h6 class="mb-1"><a href="apps-nft-item-details">The Chirstoper</a></h6>
                                                <p class="text-muted mb-0"> Crypto Card</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td><img src="{{ URL::asset('assets/images/svg/crypto-icons/usdt.svg') }}"
        ...
        <div class="col-xxl-3 col-lg-6">
            <div class="card card-height-100">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-1">
                        <p class="mb-1"><img src="{{ URL::asset('assets/images/flags/us.svg') }}" alt=""
                                height="15" class="rounded me-2"> United States <span class="float-end">34%</span></p>
                        <p class="mb-1"><img src="{{ URL::asset('assets/images/flags/russia.svg') }}" alt=""
                                height="15" class="rounded me-2"> Russia <span class="float-end">27%</span></p>
                        <p class="mb-1"><img src="{{ URL::asset('assets/images/flags/spain.svg') }}" alt=""
                                height="15" class="rounded me-2"> Spain <span class="float-end">21%</span></p>
                        <p class="mb-1"><img src="{{ URL::asset('assets/images/flags/italy.svg') }}" alt=""
                                height="15" class="rounded me-2"> Italy <span class="float-end">13%</span></p>
                        <p class="mb-0"><img src="{{ URL::asset('assets/images/flags/germany.svg') }}" alt=""
        ...
        <div class="col-xxl-3 col-lg-6">
            <div class="card">
                <div class="card-header d-flex align-items-center">
                    ...
                    <a href="apps-nft-collections" type="button" class="btn btn-soft-primary btn-sm flex-shrink-0">
                        See All <i class="ri-arrow-right-line align-bottom"></i>
                    </a>
                </div>
                <div class="card-body">
