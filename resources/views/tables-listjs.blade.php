                        ...
                        <div data-simplebar style="height: 242px;" class="mx-n3">
                            <ul class="list list-group list-group-flush mb-0">
                                ...
                                <li class="list-group-item" data-id="3">
                                    <div class="d-flex">
                                        <div class="flex-grow-1">
                                            <h5 class="fs-13 mb-1"><a href="#" class="link name text-body">Martina
                                                    Elm</a></h5>
                            ...
                            <ul class="list list-group list-group-flush mb-0">
                                    ...
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div class="flex-grow-1 overflow-hidden">
                                            <h5 class="contact-name fs-13 mb-1"><a href="#"
                                                    class="link text-body">Jonny Stromberg</a></h5>
                                ...
                                <li class="list-group-item" data-id="02">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 overflow-hidden">
                                            <h5 class="contact-name fs-13 mb-1"><a href="#"
                                                    class="link text-body">Jonas Arnklint</a></h5>
                                ...
                                <li class="list-group-item" data-id="03">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            <h5 class="contact-name fs-13 mb-1"><a href="#"
                                                    class="link text-body">Martina Elm</a></h5>
                                ...
                                <li class="list-group-item" data-id="04">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            <h5 class="contact-name fs-13 mb-1"><a href="#"
                                                    class="link text-body">Gustaf Lindqvist</a></h5>
                            ...
                            <ul class="list list-group list-group-flush mb-0">
                                <li class="list-group-item">
                                    <div class="d-flex align-items-center pagi-list">
                                        ...
                                        <div class="flex-grow-1 overflow-hidden">
                                            <h5 class="fs-13 mb-1"><a href="#" class="link text-body">Jonny
                                                    Stromberg</a></h5>
                                ...
                                <li class="list-group-item">
                                    <div class="d-flex align-items-center pagi-list">
                                        ...
                                        <div class="flex-grow-1 overflow-hidden">
                                            <h5 class="fs-13 mb-1"><a href="#" class="link text-body">Jonas
                                                    Arnklint</a></h5>
                                ...
                                <li class="list-group-item">
                                    <div class="d-flex align-items-center pagi-list">
                                        ...
                                        <div class="flex-grow-1">
                                            <h5 class="fs-13 mb-1"><a href="#" class="link text-body">Martina
                                                    Elm</a></h5>
                                ...
                                <li class="list-group-item">
                                    <div class="d-flex align-items-center pagi-list">
                                        ...
                                        <div class="flex-grow-1">
                                            <h5 class="fs-13 mb-1"><a href="#" class="link text-body">Gustaf
                                                    Lindqvist</a></h5>
